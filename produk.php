...
<body>
  ...
  <script type="text/javascript"
    src="vendor/jquery-number/jquery.number.min.js"></script>F
  ...
  <script>
    $(document).ready(function () {
      ...
      $('#form-tambah-produk').submit(function (event) {
        ...
        $.ajax({
          type: 'POST',
          url: 'controller/produk/tambahproduk.php',
          data: data,
          dataType: 'json',
      ...
      $('#tabel').on('click', '.btn-delete', function () {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: 'controller/produk/deleteproduk.php',
              method: 'POST',
              data: { id: id },
              dataType: 'json',
              success: function (response) {
      ...
      $('#tabel').on('click', '.btn-edit', function () {
        ...
        // Set value form pada modal edit produk
        $('#editId').val(id);
        $('#editNama').val(nama);
        $('#editHarga').val(harga);
      ...
      $(document).on('submit', '#formEditProduk', function (e) {
        ...
        // Ambil data dari form
        var idproduk = $('#editId').val();
        var namaProduk = $('#editNama').val();
        var hargaProduk = parseInt($('#editHarga').val());
        ...
        $.ajax({
          url: 'controller/produk/editproduk.php',
          type: 'POST',
          data: data,
          success: function (response) {
